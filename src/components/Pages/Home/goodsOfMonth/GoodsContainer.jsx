...
import goods from "../../../../assets/img/MonthsGoods/GoodsOfMonth.png";
	...
	return (
		<div>
			...
			<div class={style.goodsContainer}>
				<div className={style.goodsHigh}>
					<img src={goods} alt="goods" />
					<div className={style.goodsIcons}>
				...
				<div className={style.lastPrice}>
					<span className={style.lastPriceText}>178000</span>
					<span className={style.lastPriceBox}>-10%</span>
				</div>

				<div className={style.bottom}>
					<span className={style.finalPrice}>178000</span>
